...
% ylabel('Friction Torques (Nm)')
% title ('Friction Torques - Rotational Speed')
...
%Tengine_smooth =  smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(Tengine))))))); 
Tengine_smooth = smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(smoothdata(Tengine)))))))); 
